...
// Code chỉnh sửa hãng xe
if(isset($_POST['submit']))
{
$brand=$_POST['brand'];
$id=$_GET['id'];
$sql="update  hangxe set TenHang=:brand where id=:id";
...
<?php
$id=$_GET['id'];
$ret="select * from hangxe where id=:id";
...
?>
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control" value="<?php echo htmlentities($result->TenHang);?>" name="brand" id="brand" required>
												</div>
											</div>
