...
$sql = "delete from baohiem WHERE  id=:delid";
$query = $dbh->prepare($sql);
$query -> bindParam(':delid',$delid, PDO::PARAM_STR);
$query -> execute();
$msg=" 	Dữ liệu bảo hiểm xe đã được xóa";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Quản Lý Bảo Hiểm Xe</h2>
...
<?php $sql = "SELECT thongtinxe.TenXe,thongtinxe.id, baohiem.*
    from baohiem 
...
<a href="manage-insurance.php?del=<?php echo $result->id;?>" onclick="return confirm('Bạn có muốn xóa hồ sơ xe');"><i class="fa fa-close"></i></a></td>
                                ...
                                <div class="col-sm-8 col-sm-offset-2" align="center" style="margin-left:13%;margin-right:auto;display:block;margin-top:0%;margin-bottom:auto;">
													<a href="add-insurance.php" class="btn btn-primary" name="submit" type="button" id="submit"style="font-size: medium;">Thêm mới</a>
												</div>
