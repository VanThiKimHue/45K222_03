...
<head>
	...
	<title>Motorbike Rental Management | Admin Update Image 3</title>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Thay đổi hình ảnh 3</div>
...
<?php
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from thongtinxe where thongtinxe.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
