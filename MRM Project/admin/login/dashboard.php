			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Bảng Quản Lý</h2>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Khách Hàng</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php
$sql1 ="SELECT id from thongtinxe ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Số Lượng Xe</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Số Lượng Đơn Thuê</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Số Lượng Hãng Xe</div>
												</div>
											</div>
